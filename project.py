...
def login():
    ...
    if(username != "admin" or password != "sggs"):
        ...
        student = Button(rt,text="STUDENT",bg="green",font=("italic",20),command = student)
        student.place(x=20, y=300)

        faculty= Button(rt,text="FACULTY",bg="green",font=("italic",20),command = faculty)
        faculty.place(x=20, y=400)

        course = Button(rt,text="COURSE",bg="green",font=("italic",20),command = course)
        course.place(x=20, y=500)

        

        department = Button(rt,text="DEPARTMENT",bg="green",font=("italic",20),command = department)
        department.place(x=500, y=400)

        contact = Button(rt,text="CONTACT US",bg="green",font=("italic",20),command = contact_us)
...
username = Label(root,text='Username',font=('bold',10),bg='red')
username.place(x=20,y=60)

password = Label(root,text='Password',font=('bold',10),bg='red')
